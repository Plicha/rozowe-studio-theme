...
function rozowe_studio_scripts() {
    ...
    if (false && file_exists(get_template_directory() . '/dist/css/main.css')) {
        // Development - use Parcel dev server
        wp_enqueue_style('rozowe-studio-style', 'http://0.0.0.0:1234/main.scss', array(), $theme_version);
        wp_enqueue_script('rozowe-studio-js', 'http://0.0.0.0:1235/main.js', array(), $theme_version, true);
    } else {
